...
def get_mpnet_path(q, mlp_model, h, validity_checker_obj):
    '''
    '''
    total_vertices = 0
    success = False
...
def main(args):
    ...
    validity_checker_obj = rre.PCStateValidityChecker(si)
    ...
    for i, joint_path in enumerate(start_n_goal):
        ...
        # Get path
        pred_traj, total_vertices, success = get_mpnet_path(q, mlp_model, h, validity_checker_obj)
    ...
    fileName = osp.join(model_folder, f'real_world_eval_val_plan_mpnet_{0:06d}.p')
